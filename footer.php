              ...
              <div class="col-lg-4 col-md-6 footer-widget footer-about">
                ...
                <div class="footer-social">
                  <ul>
                    <li>
                      <a
                        href="https://facebook.com/kgfconstruction"
                        aria-label="Facebook"
                    ...
                    <li>
                      <a
                        href="https://twitter.com/kgfconstruction"
                        aria-label="Twitter"
                    ...
                    <li>
                      <a
                        href="https://instagram.com/kgfconstruction"
              ...
              <div class="col-md-6">
                <div class="copyright-info text-center text-md-left">
                  <span
                    ...
                    <a href="https://kgfconstruction.herokuapp.com">Kgfconstruction</a></span
                  >
                </div>
              </div>
