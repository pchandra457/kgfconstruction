    ...
    <div class="body-inner">
      ...
      <div class="banner-carousel banner-carousel-1 mb-0">
        <div
          ...
          style="background-image: url(images/slider-main/bg1.jpeg)"
        >
              ...
              <div class="row align-items-center h-100">
                <div class="col-md-12 text-center">
                  <h2 class="slide-title" data-animation-in="slideInLeft">
                    4 Years of excellence in
                  </h2>
                  <h3 class="slide-sub-title" data-animation-in="slideInRight">
                    Construction Industry
                  </h3>
                  <p data-animation-in="slideInLeft" data-duration-in="1.2">
                    <a href="services.php" class="slider btn btn-primary"
                      >Our Services</a
                    >
        ...
        <div
          class="banner-carousel-item"
          style="background-image: url(images/slider-main/bg2.jpeg)"
        >
        ...
        <div
          class="banner-carousel-item"
          style="background-image: url(images/slider-main/bg3.jpeg)"
        >
            ...
            <div class="col-lg-4">
              <div class="ts-service-box d-flex">
                ...
                <div class="ts-service-box-info">
                  ...
                  <p>
                  Built your dream home with our experienced team. Kgfconstruction is your one stop solution
                   for your dream home because we will transform your dream into reality.
                  </p>
                </div>
              </div>
              <!-- Service 1 end -->
