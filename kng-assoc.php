    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">K&G Associate</h2>

          <div class="row">
            <div class="col-md-12">
              <p>K&G Associate, a team of best architects and interior designer, you can rely on us for your Home design, Approval of Municipal Drawings, Plans. We provide all architectural service for residential and commercial building.</p>
            </div><!-- col end -->
          </div><!-- 1st row end-->
          ...
          <div id="page-slider" class="page-slider">
            <div class="item">
              <img loading="lazy" class="img-fluid" src="https://kgfconstruction.com/images/projects/project1.jpg" alt="project-slider-image" />
            </div>

            <div class="item">
              <img loading="lazy" class="img-fluid" src="https://kgfconstruction.com/images/projects/project6.jpg" alt="project-slider-image" />
            </div>
          </div><!-- Page slider end -->
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <p>All our projects are conceived and executed under the direct supervision of architect. Our highly competent and skilled workforce uses the highest quality materials to create aesthetic, contemporary, innovative and luxurious interiors and exteriors.</p>
              <ul class="list-arrow">
